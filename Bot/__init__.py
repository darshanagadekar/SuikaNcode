...
OWNER_ID = int(os.environ.get('OWNER_ID', 1557539460))
MONGO_DB = os.environ.get("MONGO_DB", 'your mongodb') #MONGO DB FOR ANIME DATA
FILES_CHANNEL = os.environ.get("FILES_CHANNEL", -1002107173278)    # Must Fill This ,Add Bot As Admin In Log Channel
